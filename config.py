...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/BadshahAk/SOFTYXMUSIC",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/my_lyf_diary")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/Love_x_frnd")
